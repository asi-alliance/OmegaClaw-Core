...
### Purpose
Send a message to the currently active communication channel (IRC, Telegram, Slack, Discord, or Mattermost).
...
### Notes / Limits
- Delegates to `irc.getLastMessage`, `telegram.getLastMessage`, `slack.getLastMessage`, `discord.getLastMessage`, or `mattermost.getLastMessage`.
